...
const BlogPostCard = ({ title, description, link, isLarge = false }) => (
  <div className={`rounded-2xl bg-white shadow-lg transition-transform duration-300 hover:scale-[1.02] hover:shadow-2xl overflow-hidden ${isLarge ? 'md:col-span-2' : ''}`}>
    ...
    <div className="p-6">
      <h3 className={`font-bold text-green-800 mb-2 ${isLarge ? 'text-3xl' : 'text-xl'}`}>{title}</h3>
...
const FAQItem = ({ question, answer, isOpen, onToggle }) => (
  <div className="border-b border-gray-200 last:border-none">
    ...
    >
      <span className="text-xl font-medium text-green-800">{question}</span>
      <svg
...
const Resource = () => {
  ...
  return (
    <main className="px-6 md:px-16 py-16 w-full font-sans">
      
      <header className="relative py-24 rounded-3xl overflow-hidden shadow-2xl animate-fade-in-down">
        ...
        <div className="relative text-center text-white space-y-6 z-10 max-w-7xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-tight drop-shadow-lg font-display">
          ...
          {!user && (
            <Link
              to="/register-choice"
              className="inline-block px-12 py-4 bg-white text-green-700 font-semibold rounded-full shadow-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300"
            >
              Get Started
            </Link>
          )}
      ...
      <div className="max-w-7xl mx-auto space-y-28">
          <section className="animate-fade-in-up mt-24">
            <h2 className="text-4xl font-semibold text-green-800 mb-10 text-center font-display">Quick Guides</h2>
          ...
          <section className="animate-fade-in-up">
            ...
            <div className="relative rounded-3xl p-10 bg-gray-100 shadow-xl overflow-hidden">
          ...
          <section className="animate-fade-in-up">
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl p-8 divide-y divide-gray-200">
              {faqs.length ? (
                faqs.map((faq, i) => (
                  <FAQItem
                    key={faq._id}
          ...
          {!user && (
            <section className="bg-green-700 rounded-3xl p-16 text-center shadow-2xl animate-fade-in-up">
              ...
              <Link
                to="/register-choice"
                className="inline-block px-14 py-5 bg-white text-green-700 font-semibold rounded-full shadow-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300"
              >
                Create Your Account
              </Link>
            </section>
