...
const RegisterChoice = () => {
  ...
  return (
    <div className="w-screen h-screen bg-gradient-to-br from-green-50 to-green-100 overflow-hidden">
      <div className="relative w-full h-full bg-white shadow-2xl overflow-hidden">
        <div
          className={`absolute top-0 left-0 w-1/2 h-full bg-gradient-to-br from-green-800 via-green-900 to-black text-white p-10 flex flex-col justify-center items-center transition-all duration-700 z-20 ${
        ...
        >
          ...
          <button
            ...
            className="bg-green-500 text-white font-semibold px-8 py-3 rounded-full shadow-lg hover:scale-105 hover:bg-green-600 transition-all"
          >
